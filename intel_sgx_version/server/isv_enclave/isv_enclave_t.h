...
sgx_status_t enclave_generate_key(uint8_t* p_data, uint32_t secret_size);
sgx_status_t enclave_encrypt(uint8_t* p_data, uint32_t secret_size, uint8_t* out_data);
sgx_status_t enclave_decrypt(uint8_t* p_data, uint32_t secret_size, uint8_t* out_data);
